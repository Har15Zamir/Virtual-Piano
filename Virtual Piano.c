...
void playnote(char note) {
    if (note == 'A') printf("Beep(440, 500)");    
    else if (note == 'B') printf("Beep(494, 500)");  
    else if (note == 'C') printf("Beep(523, 500)");  
    else if (note == 'D') printf("Beep(587, 500)");  
    else if (note == 'E') printf("Beep(659, 500)");  
    else if (note == 'F') printf("Beep(698, 500)");  
    else if (note == 'G') printf("Beep(784, 500)");  
    else if (note == 'H') printf("Beep(554, 500)");  
    else if (note == 'I') printf("Beep(622, 500)");  
    else if (note == 'J') printf("Beep(740, 500)");  
    else if (note == 'K') printf("Beep(831, 500)");
}
    ...
    if (song[i] != ' ') {
        ...
        while (1) {
            ...
            if (key == song[i]) {
                ...
                printf("Incorrect note! Try again\n");
            }
        }
    } else {
        i++;
